...
//  MLBootstrap-iOS
//
//  Created by Michel Anderson Lutz Teixeira on 05/01/20.
...
open class MLTontiatorView: UIView {
    ...
    /**
     PI contant
     */
    private let piConst = 3.14159265359
    /**
    ...
    /**
         ...
         if its MLSpinnerSizeVeryLarge or MLSpinnerSizeLarge, MLSpinnerSizeMedium,
         can able to set two title, one title in.center of spinner and another in below the spinner
     */
    ...
    */
    ...
    private func DEGREES_TO_RADIANS(degrees: Double) -> CGFloat {
        return CGFloat(((piConst * degrees) / 180))
    }
    /**
    ...
    open func stopAnimating() {
        let duration = (stopShowingAndDismissingAnimation == true) ? 0.0 : 0.5
